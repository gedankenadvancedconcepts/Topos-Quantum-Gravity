...
>
> Topos Theory created this new structural approach to shed new light on the old problems and calls it **Structural Thinking.** This method is based purely on examining the underlying structure to find universal commonalities. To properly understand this theory, one must become accustomed to applying a forgetful functor to strip away the unnecessary internal contents of objects to find the universal underlying invariant structure. It is foregoing the trees to look at the underlying relational structure that makes up the causal and dynamical structure of the forest.
>
